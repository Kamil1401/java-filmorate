...
class FilmControllerTest {
    ...
    public void beforeEach() {
        ...
        testFilm = new Film();
        testFilm.setName("Иллюзия обмана");
        ...
        testFilm.setReleaseDate(LocalDate.of(2013, 6, 12));
        testFilm.setDuration(115);
    }
    ...
    public void create_addFilmObject_titleIsNotBlank() {
        testFilm.setName(" ");
        ValidationException exception = assertThrows(ValidationException.class, () -> controller.create(testFilm));
